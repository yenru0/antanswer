...
"}")
        ...
        self.extend_normal_button_recentValue = QRadioButton(self.extend_normal)
        self.extend_normal_button_recentValue.setObjectName(u"extend_normal_button_recentValue")
        ...
        self.extend_normal_button_recent.setObjectName(u"extend_normal_button_recent")
        ...
        self.extend_normal_button_wil.setObjectName(u"extend_normal_button_wil")
        ...
        self.extend_normal_recentValue.setObjectName(u"extend_normal_recentValue")
        ...
        self.extend_normal_button_weightMult.setObjectName(u"extend_normal_button_weightMult")
        self.extend_normal_button_weightMult.setAutoExclusive(False)

        self.gridLayout.addWidget(self.extend_normal_button_weightMult, 2, 0, 1, 1)

        self.extend_normal_weightMult = QSpinBox(self.extend_normal)
        self.extend_normal_weightMult.setObjectName(u"extend_normal_weightMult")
        ...
        self.extend_normal_button_weightAlg.setObjectName(u"extend_normal_button_weightAlg")
        self.extend_normal_button_weightAlg.setAutoExclusive(False)

        self.gridLayout.addWidget(self.extend_normal_button_weightAlg, 2, 2, 1, 1)
...
"")
        ...
        self.extend_normal_button_recent.toggled.connect(self.extend_normal_recent.setEnabled)
        self.extend_normal_button_recentValue.toggled.connect(self.extend_normal_recentValue.setEnabled)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actiongotooption.setText(QCoreApplication.translate("MainWindow", u"\uc635\uc158", None))
        ...
        self.extend_normal_button_recentValue.setText(QCoreApplication.translate("MainWindow", u"recentValue", None))
        self.extend_normal_button_recent.setText(QCoreApplication.translate("MainWindow", u"recent", None))
        self.extend_normal_button_wil.setText(QCoreApplication.translate("MainWindow", u"wil", None))
        self.extend_normal_button_weightMult.setText(QCoreApplication.translate("MainWindow", u"\uac00\uc911\uce58 \uac00\uc0b0 \ubc30\uc218", None))
        self.extend_normal_button_weightAlg.setText(QCoreApplication.translate("MainWindow", u"\uac00\uc911\uce58 \uacc4\uc0b0 \ubc29\uc2dd", None))
        self.extend_normal_weightAlg.setItemText(0, QCoreApplication.translate("MainWindow", u"\uac00\uc0b0\uc5c6\uc74c", None))
        self.extend_normal_weightAlg.setItemText(1, QCoreApplication.translate("MainWindow", u"\uc77c\ucc28\uc801", None))
        ...
        self.option_btn_back.setText(QCoreApplication.translate("MainWindow", u"\ub3cc\uc544\uac00\uae30", None))
        self.option_btn_save.setText(QCoreApplication.translate("MainWindow", u"\uc800\uc7a5\ud558\uae30", None))
